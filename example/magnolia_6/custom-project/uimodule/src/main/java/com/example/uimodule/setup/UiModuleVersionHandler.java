package com.example.uimodule.setup;
 ...
 */
public class UiModuleVersionHandler extends DefaultModuleVersionHandler {
    @Override
    protected List<Task> getExtraInstallTasks(InstallContext installContext) {
        ...
        tasks.add(new BootstrapSingleModuleResource("config.modules.uimodule.apps.xml"));
